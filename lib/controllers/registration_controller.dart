...
class RegisterViewModel extends GetxController {
  ...
  // Future<void> verifyPhoneWithOtp({required String phoneNumber}) async {
  //   await utilsProvider.auth.verifyPhoneNumber(
  ...
  //         await utilsProvider.auth.signInWithCredential(authCredential);
  //       }
  //     }
  //       isLoading.value = false;
